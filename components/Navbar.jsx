    ...
    return (
        <>
            <div className="fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden">
                <img src="/assets/icons/header-bg-color.png" alt="" className="w-full" />
            </div>
            ...
            <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
                ...
                <a href="https://prebuiltui.com?utm_source=eliana">
                    <img src="/assets/logos/logo.png" alt="Logo" className="w-28 cursor-pointer mr-14 dark:hidden" />
                    <img src="/assets/logos/logo_dark.png" alt="Logo" className="w-28 cursor-pointer mr-14 hidden dark:block" />
                </a>
                ...
                <div className="flex items-center gap-4">
                    <button onClick={toggleTheme}>
                        <img src="/assets/icons/moon_icon.png" alt="" className="w-5 dark:hidden" />
                        <img src="/assets/icons/sun_icon.png" alt="" className="w-5 hidden dark:block" />
                    </button>
                    ...
                    <a href="#contact" className="hidden lg:flex items-center gap-3 px-8 py-1.5 border border-gray-300 hover:bg-slate-100/70 dark:hover:bg-darkHover rounded-full ml-4 font-Ovo dark:border-white/30">
                        Contact
                        <img src="/assets/icons/arrow-icon.png" alt="" className="w-3 dark:hidden" />
                        <img src="/assets/icons/arrow-icon-dark.png" alt="" className="w-3 hidden dark:block" />
                    </a>

                    <button className="block md:hidden ml-3" onClick={openMenu}>
                        <img src="/assets/icons/menu-black.png" alt="" className="w-6 dark:hidden" />
                        <img src="/assets/icons/menu-white.png" alt="" className="w-6 hidden dark:block" />
                    </button>
                ...
                <ul ref={sideMenuRef} className="flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 font-Ovo dark:bg-darkTheme dark:text-white">
                    ...
                    <div className="absolute right-6 top-6" onClick={closeMenu}>
                        ...
                        <img src="/assets/icons/close-white.png" alt="" className="w-5 cursor-pointer hidden dark:block" />
                    </div>
